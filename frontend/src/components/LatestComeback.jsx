    ...
    >
      <div className="relative w-full h-full rounded-bl-none rounded-tr-none rounded-4xl overflow-hidden">
        ...
        />
          ...
          <img src={assets.cb} alt="" className="w-full h-full object-cover rounded-4xl rounded-tr-none rounded-bl-none relative z-10 animate-content-shift rounded-b-none"/>
